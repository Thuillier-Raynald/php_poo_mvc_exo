...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 12 fév. 2021 à 14:56
...
INSERT INTO `association_vehicule_conducteur` (`id`, `idvehicule`, `idconducteur`) VALUES
(1, 501, 1),
(2, 502, 2),
(3, 503, 3),
(4, 504, 4),
...
ALTER TABLE `association_vehicule_conducteur`
  ADD CONSTRAINT `idconducteur` FOREIGN KEY (`idconducteur`) REFERENCES `conducteur` (`id`),
